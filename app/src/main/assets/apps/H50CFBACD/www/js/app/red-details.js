...
function lessTime(ktime,stime){
	 var te=parseFloat(stime)-parseFloat(ktime);
	 if(te<60){
	 	return te+'秒';
	 }else if(te<3600){
	 	 te-6; 
	 	return parseInt(te/60)+'分'+parseInt(te%60)+'秒';
	 }else if(te<86400){
	 	var i=te%3600;
	 	 return parseInt(te/3600)+'小时'+parseInt(i/60)+'分'+parseInt(te%60)+'秒';
	 }
